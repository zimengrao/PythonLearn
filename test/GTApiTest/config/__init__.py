...
class Config:
    ...
    enum = {
        'GTApi': {
            'homepage': 'http://test.greattone.net',
            'test': {
                ...
                'guangchang': {
                    'guang_url': '?api=info/guanlist&classid=1&extra=shipin,hai_id,hai_video,hai_photo,hai_petition,hai_name&pageIndex=1&pageSize={}&loginuid={}&logintoken={}',
                    'value': [
                        ...
                        '&timehot=3&ismember=1&query=onclick',  # 月热动态参数
                        '&timehot=2&ismember=1&query=onclick',  # 周热动态参数
                    ],

                },
               'guan_url': '?api=zhiyin/list&logintoken={}&loginuid={}&pageIndex=1&pageSize=20&iszhiyin=0'
            }
        }
    }
...
class BusinessApi(HttpHandler):
    def __init__(self):
        ...
        self.url = self.config.get_config('HTTP', 'baseurl') # 3.6接口地址
    ...
    def get_token(self):
        ...
        resp = json.loads(self.http.post(self.url_4 + self.login_path, data = post_data))
        # print(resp)
    ...
    def login(self, userid, password):
        ...
        result = json.loads(self.http.post(self.url_4 + self.login_path, data=data))

...
class KuaiShou:
    def __init__(self):
        ...
        self.single = '__NStokensig=655a439189df16f3c8dd12346b20fd2b2abf787ea70438dd9cb7b6ad421c1f95&client_key=56c3713c&content=%E8%BF%98%E8%A6%81%E4%BA%BA%E5%90%97&country_code=cn&language=zh-Hans-CN%3Bq%3D1%2C%20zh-Hant-CN%3Bq%3D0.9&photo_id={}&refer=ks%3A%2F%2Fphoto%2F{}%2F{}%2F3%2F1_i%2F1605145365382963207_h123%23addcomment&sig=7d215b7e379b2ca08adea7edf47e0899&token=f7c4c199c3044ce1a0431f6a40818bf3-997239509&user_id={}'
    ...
    def review(self):
        ...
        for item in resp:
            ...
            single_data = self.single.format(user_id, photo_id, photo_id, user_id)
